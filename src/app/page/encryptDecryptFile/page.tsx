    ...
    return (
        <div className='flex flex-col items-center justify-center'>
            <div>
                ...
                <br/>
                <div className='flex'>
                    <button className="btn btn-neutral " onClick={() => EncryptFile(password)}>Зашифровать файл</button>
                    <button className="btn btn-neutral " onClick={() => DecryptFile(password)}>Расшифровать файл
                    </button>
                </div>
            </div>
        </div>
